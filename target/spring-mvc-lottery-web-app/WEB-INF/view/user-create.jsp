                ...
                <main class="form-signin">
                  <c:url value="/user/save" var="url">
                    ...
                    <form:form action="${url}" modelAttribute="userForm" method="POST">
                      <p class="sign-title">Create User</p>
                      ...
                      <br>
                      <button class="header-button" id="sign-button" type="submit">Create</button>
                      <div class="mt-4">
                        <a href="${pageContext.request.contextPath}/user/panel/${loggedUserId}" class="text-secondary"><p class="text-center">Return to User panel</p></a>
                      </div>
                    </form:form>
                  </main>
            </body>
